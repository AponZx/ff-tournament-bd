      ...
      <div className="p-3 space-y-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
          ...
          <div className="p-4 pt-5">
            ...
            <div className="flex justify-between text-[10px] text-gray-500 mb-1 px-1"><span>Duo</span><span>Bermuda</span><span>MOBILE</span></div>
            <div className="flex justify-between text-[10px] text-gray-500 mb-1"><span>Only 0 spots are left</span><span className="font-bold">48/48</span></div>
            ...
            <div className="flex gap-2 mb-4">
              ...
              <button className="flex-1 border border-gray-200 rounded-lg py-2 text-xs font-bold text-blue-600">🏆 Prize Pool</button>
            </div>
          </div>
          <div className="bg-[#e53935] text-white text-center py-2.5 font-bold text-sm">Room Created Join Now</div>
        </div>
      </div>
    </div>
  );
