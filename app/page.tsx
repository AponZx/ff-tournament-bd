...
export default function Home() {
  const categories = [
    ...
    { title: 'BR SURVIVAL / SQUAD', desc: '6 matches found', image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=400', link: '/matches/fullmap', badge: 'SURVIVAL' },
    { title: 'CLASH SQUAD', desc: '38 matches found', image: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?auto=format&fit=crop&q=80&w=400', link: '/matches/cs', badge: 'CS' },
    { title: 'CS 1v1 2v2', desc: '143 matches found', image: 'https://images.unsplash.com/photo-1534423861386-85a16f5d13fd?auto=format&fit=crop&q=80&w=400', link: '/matches/cs1v1', badge: 'CS' },
  ];
        ...
        <div className="grid grid-cols-2 gap-3">
          {categories.map((cat, i) => (
            <Link href={cat.link} key={i} className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 block active:scale-95 transition-transform">
              ...
              <div className="p-2">
                <h3 className="font-bold text-xs truncate">{cat.title}</h3>
